...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("老用户-原套餐：先购买短期版，再购买长期版= " + money.regularUsersD1("499", "595", "1995840742", "1617149542"));
        System.out.println("老用户-原套餐：先购买短期版，再购买长期版 = " + money.regularUsersD1("49.9", "595", "1995840742", "1617149542"));
        System.out.println("老用户-原套餐为 正常购买专业版 = " + money.regularUsersD1("499", "1468", "1869568659", "1617107859"));
        System.out.println("老用户-原套餐为 正常购买专业版 = " + money.regularUsersD1("49.9", "1468", "1869568659", "1617107859"));

        System.out.println("=============老用户 小于1年=============");
        System.out.println("老用户-原套餐为 正常购买专业版= " + money.regularUsersX1("499", "108", "1659323816", "1627787816"));
        System.out.println("老用户-原套餐为 正常购买专业版= " + money.regularUsersX1("49.9", "108", "1659323816", "1627787816"));
