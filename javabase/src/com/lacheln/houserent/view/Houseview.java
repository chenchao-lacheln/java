...
public class Houseview {
    ...
    //根据id修改房屋信息
    //注意：返回的是引用类型【即：就是数组的元素】
    //因此后面对hhouse.setXxx(),就会修改HouseService中的housesh数组的元素！！！！！
    public void update(){
        ...
        String name = Utility.readString('8', "");//用户如果直接回车，表示不修改该信息，默认""
        if (!"".equals(name)){
            house.setName(name);//修改
        }
